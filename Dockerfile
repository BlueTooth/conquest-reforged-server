...
RUN wget --output-document=forge-installer.jar http://files.minecraftforge.net/maven/net/minecraftforge/forge/1.10.2-12.18.3.2422/forge-1.10.2-12.18.3.2422-installer.jar && \
...
CMD java -Xmx4096M -Xms4096M -jar forge-1.10.2-12.18.3.2422-universal.jar --installServer nogui
